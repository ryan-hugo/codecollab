...
import { authAPI, snippetAPI, getToken, setToken, removeToken, getErrorMessage } from '@/services';
import type { LoginSchema, RegisterSchema, CreateSnippetSchema, SearchSnippetsParams } from '@/services';
